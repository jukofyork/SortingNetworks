...
void CreateIsSorted(void)
{ // Sets up the IsSorted vector so we can test for if sorted in 1 operation
...
void CreateAllowedOps(void)
{ // Creates tables used to check which ops are allowed for RandomTransition()
  // function.
...
{ // Creates the lookup tables needed by State class.
